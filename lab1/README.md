...
<img width="1268" height="205" alt="image" src="https://github.com/user-attachments/assets/c4385222-634b-45a2-9f2d-8dc91213a78d" />
...
8) docker start minio-server
  ...
  ## Вывод
В ходе лабораторной работы были изучены основы Docker: установка, запуск контейнеров в фоновом режиме и мониторинг их состояния через CLI. Также были освоены навыки настройки объектного хранилища в MinIO
